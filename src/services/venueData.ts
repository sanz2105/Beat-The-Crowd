...
export const initialZones: Record<string, Zone> = {
  ...
  gate_b:     { name: "Gate B",           type: "gate",       crowdLevel: "high",   waitTime: 18, isOpen: true,  capacity: 92 },
  ...
  food_north: { name: "Food Court North", type: "food",       crowdLevel: "high",   waitTime: 22, isOpen: true,  capacity: 88 },
...
export const subscribeToZones = (callback: (zones: Record<string, Zone>) => void) => {
